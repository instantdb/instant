...
export const LINKEDIN_AUTHORIZATION_ENDPOINT =
  'https://www.linkedin.com/oauth/v2/authorization';
export const LINKEDIN_TOKEN_ENDPOINT =
  'https://www.linkedin.com/oauth/v2/accessToken';
export const LINKEDIN_DISCOVERY_ENDPOINT =
  'https://www.linkedin.com/oauth/.well-known/openid-configuration';
export const LINKEDIN_DEFAULT_CALLBACK_URL =
  'https://api.instantdb.com/runtime/oauth/callback';
