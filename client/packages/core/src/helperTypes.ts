...
/**
 * @deprecated `InstantQuery` is deprecated. Use `InstaQLParams` instead.
 * @example
 *   // Before
...
/**
 * @deprecated `InstantQueryResult` is deprecated. Use `InstaQLResult` instead.
 * @example
 *   // Before
 *   const db = init_experimental({ ...config, schema });
 *   type DB = typeof db;
...
export type InstantQueryResult<DB extends IInstantDatabase<any>, Q> =
  DB extends IInstantDatabase<infer Schema>
    ...
    : never;
/**
 * @deprecated `InstantSchema` is deprecated. Use typeof schema directly:
 * @example
 *   // Before
 *   const db = init_experimental({ ...config, schema });
...
/**
 * @deprecated `InstantEntity` is deprecated. Use `InstaQLEntity` instead.
 * @example
 *   // Before
 *   const db = init_experimental({ ...config, schema });
 *   type DB = typeof db;
...
/**
 * @deprecated `InstantSchemaDatabase` is deprecated. You generally don't need
 *   to create a return type for a DB. But, if you like you can use
 *   `IInstantDatabase`:
 * @example
 *   // Before
