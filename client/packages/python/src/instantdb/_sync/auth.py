...
class Auth:
    ...
    def send_magic_code(self, email: str) -> str:
    ...
    def generate_magic_code(self, email: str) -> str:
        result = self._http.post(
            "/admin/magic_code",
            params={"app_id": self._app_id},
            json={"email": email},
    ...
    def create_token(self, *, email: str | None = None, id: str | None = None) -> str:
    ...
    def get_user(
        ...
        *,
        ...
        params["app_id"] = self._app_id
        result = self._http.get("/admin/users", params=params)
        return result["user"]
