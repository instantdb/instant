  ...
  return (
    <div className="prose prose-h1:mb-4 prose-h1:mt-8 prose-h2:mb-2 prose-h2:mt-4 prose-pre:bg-gray-100">
      ...
      <p>
        ...
        itself or through third parties, there are: Trackers; Usage Data; number
        of Users; session statistics.
      </p>
      <p>
      ...
      <h2 id="mode-and-place-of-processing-the-data">
      ...
      <h2 id="detailed-information-on-the-processing-of-personal-data">
      ...
      <ul>
        <li>
          ...
          <h4 id="google-analytics-4-google-llc">
      ...
      <p>This Application uses Trackers.</p>
      <h2 id="further-information-for-users">Further Information for Users</h2>
      ...
      <h3 id="further-information-about-retention-time">
      ...
      <h3 id="the-rights-of-users-based-on-the-general-data-protection-regulation-gdpr">
      ...
      <ul>
        ...
        <li>
          ...
          right to restrict the processing of their Data. In this case, the
          Owner will not process their Data for any purpose other than storing
          it.
        </li>
        <li>
          <strong>
      ...
      <h4 id="details-about-the-right-to-object-to-processing">
      ...
      <h2 id="additional-information-about-data-collection-and-processing">
      ...
      <h3 id="information-not-contained-in-this-policy">
      ...
      <h3 id="definitions-and-legal-references">
      ...
      <p>
        ...
        various time details per visit (e.g., the time spent on each page within
        the Application) and the details about the path followed within the
        Application with special reference to the sequence of pages visited, and
        other parameters about the device operating system and/or the User&#39;s
        IT environment.
      </p>
      <h4 id="user">User</h4>
      <p>
      ...
      <h4 id="data-processor-or-processor">Data Processor (or Processor)</h4>
      <p>
      ...
      <h4 id="this-application">This Application</h4>
      <p>
