/**
 * Script for generating LLM rule files for various AI-powered IDEs
 *
 * This script generates markdown files with InstantDB documentation and
 * instructions for different AI coding assistants (Claude, Cursor, Windsurf, etc).
 *
...
const FULL_EXAMPLE_APP = `# Full Example App
...
async function main() {
  const files = [
    ...
    { filename: 'claude.md', build: buildClaude },
