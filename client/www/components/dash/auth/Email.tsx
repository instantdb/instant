...
const formDefaults = {
  subject: defaultMagicCodeEmailConfig.authEmail.subject,
  bodyHtml: defaultMagicCodeEmailConfig.authEmail.body,
  from: defaultMagicCodeEmailConfig.authEmail.from,
  senderEmail: defaultMagicCodeEmailConfig.authEmail.fromAddress ?? '',
};
