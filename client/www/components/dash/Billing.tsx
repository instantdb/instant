...
export default function Billing({ appId }: { appId: string }) {
  ...
  if (orgIsPaid) {
    return (
      <div className="">
        <div className="parent rounded-lg p-3">
  ...
  return (
    <div className="flex max-w-md flex-col gap-4 p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {isFreeTier ? (
          <div className="rounded-lg border px-2 py-1 font-bold dark:border-neutral-600">
            {subscriptionName}
          </div>
        ) : (
          <div style={{ animation: 'wiggle 5s infinite' }}>
            <div
              ref={confettiRef}
              className="translate-y-0 cursor-pointer rounded-lg border border-orange-300 bg-orange-100 px-2 py-1 font-mono font-bold text-orange-800 transition-all select-none hover:-translate-y-1 active:scale-90 dark:border-orange-400/50 dark:bg-orange-800/40 dark:text-orange-100"
              onClick={(e) => {
      ...
      <div className="gap flex flex-col rounded-lg border bg-white px-2 pt-1 pb-3 dark:border-neutral-700 dark:bg-neutral-800">
      ...
      {isFreeTier ? (
        <div className="flex flex-col space-y-4">
          ...
          <Content className="rounded-lg border border-orange-300 bg-orange-100 px-2 py-1 text-sm text-orange-800 italic dark:border-orange-500/50 dark:bg-orange-500/20 dark:text-white">
