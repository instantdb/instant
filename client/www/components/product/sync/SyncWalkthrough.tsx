...
const STEPS: Step[] = [
  {
    ...
    description:
      'Alyssa and Louis both see the same gray ball, connected to the server.',
  ...
  },
  {
    ...
    description:
      'Alyssa paints blue, Louis paints red. Both see their color instantly via pending mutations. Both changes fly to the server.',
  ...
  },
  {
    ...
    description:
      "Red enters the server. Server turns red and broadcasts to both. Alyssa's server-result turns red — but her pending blue sits on top, so her ball stays blue.",
