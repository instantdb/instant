...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description:
      'Alyssa paints the ball blue. Thanks to optimistic updates she sees her color change instantly. Her mutation then heads over to the server.',
  ...
  {
    title: 'The server accepts and broadcasts',
    description:
      "Once the server accepts the mutation, it can find all queries that care about this particular change. In this case, it's the queries that power Alyssa and Louis' browsers. They both receive updates, and Louis sees blue too.",
...
function Diagram({
  ...
  const hasDotEntering = step.alyssaDot?.position === 'server';
  const hasBroadcast =
