...
import { RevenueDashboardDemo } from './RevenueDashboardDemo';
import { LiveStreamDemo } from './LiveStreamDemo';
import { StreamsDemoJoin } from './StreamsDemoJoin';
import {
  FeatureBody,
  SectionIntro,
  SectionSubtitle,
...
export function BatteriesForAI() {
  return (
    <div className="space-y-16">
      ...
      <AnimateIn>
        <SectionIntro>
          <SectionTitle>Batteries included</SectionTitle>
          <SectionSubtitle>
            As your app grows, you start needing more services. Instant comes
            with a bunch of the fundamental ones built-in, and they're designed
      ...
      {/* Features */}
      <div className="grid-cols 2 grid auto-rows-fr gap-6 md:grid-cols-3">
        {/* Auth */}
        <AnimateIn className="flex">
          <div className="col-span-1 space-y-4">
            <div>
              ...
              <FeatureBody>
                Magic Code emails, Sign in with Google, Apple, GitHub, and
                LinkedIn are all built-in with your app. Agents can set these
                methods up in minutes and they're extendable too.
              </FeatureBody>
            </div>
        ...
        <AnimateIn className="flex">
          <div className="flex flex-col space-y-4">
            <div>
              ...
              <FeatureBody>
                Inspired from Google's Zanzibar and Facebook's EntPrivacy, get a
                permission system that lets you write both simple and
                complicated rules.
              </FeatureBody>
            </div>
        ...
        <AnimateIn className="flex">
          <div className="flex flex-col space-y-4">
            <div>
              ...
              <FeatureBody>
                You don't need a separate service to upload images and videos.
                Storage lets you upload files, and they <em>feel</em> like any
                other row in your database.
              </FeatureBody>
            </div>
