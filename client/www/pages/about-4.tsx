...
function TripleDemo() {
  ...
  return (
    <div className="flex flex-col items-stretch gap-6 lg:flex-row lg:items-start lg:gap-0">
      ...
      <div className="min-w-0 shrink-0 lg:w-[220px]">
        <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
          <div className="border-b border-gray-100 bg-gray-50/60 px-4 py-2 text-xs font-medium text-gray-400">
            Team Tasks / #42
          </div>
          <div className="px-5 py-4">
            ...
            <div className="relative mt-5 flex items-center gap-3">
              ...
              <button
                ...
                className="rounded-full border border-gray-200 p-0.5 transition-colors hover:bg-gray-50"
              >
                <img
                  src={user.img}
                  alt={user.id}
              ...
              {showDropdown && (
                <div className="absolute top-full left-12 z-10 mt-1 flex gap-1 rounded-lg border border-gray-200 bg-white p-1.5 shadow-lg">
                  {USERS.map((u, i) => (
                    <button
                      key={u.id}
      ...
      {/* Connecting line */}
      <div className="-mx-[1px] hidden lg:block">
        <svg width="48" height="60" className="overflow-visible">
          <line
            x1="0"
            y1="0"
            x2="48"
      ...
      <div className="min-w-0 shrink-0 lg:mt-10">
