...
import { FetchedDash, useFetchedDash } from '@/components/dash/MainDashLayout';
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col md:flex-row">
      <div className="flex min-h-0 min-w-[260px] flex-col gap-4 border-r p-4 text-sm md:basis-96 md:text-base dark:border-r-neutral-700">
        ...
        <DocsCard href="/docs/permissions" title="Using Permissions">
...
function PermsWithConnection({
  ...
  return (
    <DashShell active="perms" app={app}>
      <PermsContent app={app} namespaces={namespaces} />
    </DashShell>
  );
}
...
export function Current() {
  ...
  return <PermsWithConnection app={app} db={db} />;
}
