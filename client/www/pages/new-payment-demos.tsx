      ...
      <div className="mx-auto max-w-5xl px-6 py-20">
        ...
        <div className="space-y-20">
          ...
          <section>
            ...
            <h3 className="mb-6 text-2xl font-semibold">Revenue Dashboard</h3>
            <div className="rounded-xl bg-radial from-white to-[#FFF9F4] px-6 py-6">
          ...
          <section>
            ...
            <p className="mb-6 text-gray-500">
              Transactions slide in one-by-one. Running total ticks up.
              Color-coded by type.
            </p>
            <div className="rounded-xl bg-radial from-white to-[#FFF9F4] px-6 py-6">
          ...
          <section>
            ...
            <h3 className="mb-2 text-2xl font-semibold">Checkout → Ka-ching</h3>
            <p className="mb-6 text-gray-500">
              Animated cursor fills checkout form, clicks Pay, success
              animation, revenue counter ticks up.
            </p>
          ...
          <section>
            ...
            <p className="mb-6 text-gray-500">
              Toggle modes, adjust price slider, live checkout preview updates
              instantly.
            </p>
          ...
          <section>
            ...
            <p className="mb-6 text-gray-500">
              Animated timeline: signup → first charge → renewal → upgrade →
              revenue bump.
            </p>
