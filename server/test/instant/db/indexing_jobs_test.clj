(ns instant.db.indexing-jobs-test
  (:require [honey.sql :as hsql]
            ...
            [instant.fixtures :refer [with-empty-app with-zeneca-app-no-indexing *indexing-job-queue*]]
...
(deftest checks-types-works
  (with-zeneca-app-no-indexing
    (fn [app r]
      (let [job-queue *indexing-job-queue*
